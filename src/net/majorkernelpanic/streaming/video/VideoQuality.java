...
public class VideoQuality {
	...
	// IVANS PHONE:
	public final static VideoQuality defaultVideoQualiy = new VideoQuality(176,144,30,200*1024);
	
	//public final static VideoQuality defaultVideoQualiy = new VideoQuality(1280,720,24,1024*1024);
	//public final static VideoQuality defaultVideoQualiy = new VideoQuality(720,480,30,512*1024);
	  	
	//public final static VideoQuality defaultVideoQualiy = new VideoQuality(320,240,25,256*1024);
